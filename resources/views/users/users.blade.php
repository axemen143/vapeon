    ...
    <x-slot name="header">
     ...
     <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 my-5">
                <div class="p-4 mb-4 text-sm text-red-700 bg-green-100 rounded-lg dark:bg-gray-800 dark:text-green-400" role="alert">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{ url('/users/add')}}">
                    ...
                    <button class=" float-right bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-stone-900 rounded">
                    ...
                    @foreach ($users as $user)
                        ...
                        <tr>
                            ...
                            <a href="{{ url('/users/update/' . $user->id) }}">
                                 <button class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-1 px-2 border border-orange-500 rounded">Update</button>
                            </a>
